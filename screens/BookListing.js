...
import { fetchBooks, fetchBooksForBookListing, setSelectedBook } from '../store/slices/bookSlice';
...
const ResultCount = ({ title, bookList, totalPage }) => {
